...
$count_result = $conn->query("SELECT COUNT(*) AS total FROM stock_details");
$total_records = $count_result->fetch_assoc()['total'];
$total_pages = ceil($total_records / $records_per_page);

// Fetch paginated stock details
$sql_stock_details = "SELECT * FROM stock_details LIMIT $offset, $records_per_page";
...
<div class="header-container">
    ...
    <button class="btn btn-create" onclick="document.getElementById('createModal').style.display='flex'">
        <i class="fas fa-plus"></i> Create New Stock Record
    </button>
</div>
...
function openEditModal(stockId, itemId, quantity, unit, type) {
